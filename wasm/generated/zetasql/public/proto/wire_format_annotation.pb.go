...
func (TableType) Descriptor() protoreflect.EnumDescriptor {
	return file_zetasql_public_proto_wire_format_annotation_proto_enumTypes[0].Descriptor()
}

func (TableType) Type() protoreflect.EnumType {
	return &file_zetasql_public_proto_wire_format_annotation_proto_enumTypes[0]
}
...
func (TableType) EnumDescriptor() ([]byte, []int) {
	return file_zetasql_public_proto_wire_format_annotation_proto_rawDescGZIP(), []int{0}
}
...
func (x *WireFormatAnnotationEmptyMessage) Reset() {
	*x = WireFormatAnnotationEmptyMessage{}
	mi := &file_zetasql_public_proto_wire_format_annotation_proto_msgTypes[0]
...
var file_zetasql_public_proto_wire_format_annotation_proto_extTypes = []protoimpl.ExtensionInfo{
	{
...
var (
	...
	E_StructFieldName = &file_zetasql_public_proto_wire_format_annotation_proto_extTypes[0]
	...
	E_IsRawProto = &file_zetasql_public_proto_wire_format_annotation_proto_extTypes[1]
	...
	E_IsHiddenColumn = &file_zetasql_public_proto_wire_format_annotation_proto_extTypes[2]
	// Indicate that when the containing proto is converted to a SQL table,
	// the column for this field will become a measure column.
	//
	// optional bool is_measure = 535801544;
	E_IsMeasure = &file_zetasql_public_proto_wire_format_annotation_proto_extTypes[3]
)
...
var (
	...
	E_IsWrapper = &file_zetasql_public_proto_wire_format_annotation_proto_extTypes[4]
	...
	E_IsStruct = &file_zetasql_public_proto_wire_format_annotation_proto_extTypes[5]
	...
	//
	// optional zetasql.TableType table_type = 86830980;
	E_TableType = &file_zetasql_public_proto_wire_format_annotation_proto_extTypes[6]
)

var File_zetasql_public_proto_wire_format_annotation_proto protoreflect.FileDescriptor

const file_zetasql_public_proto_wire_format_annotation_proto_rawDesc = "" +
	"\n" +
	"1zetasql/public/proto/wire_format_annotation.proto\x12\azetasql\x1a google/protobuf/descriptor.proto\"\"\n" +
	...
	"\tis_struct\x12\x1f.google.protobuf.MessageOptions\x18\u0092\xdb\x17 \x01(\bR\bisStruct:U\n" +
	"\n" +
	"table_type\x12\x1f.google.protobuf.MessageOptions\x18\x84߳) \x01(\x0e2\x12.zetasql.TableTypeR\ttableTypeB/\n" +
	"\x12com.google.zetasqlB\x19WireFormatAnnotationProto"

var (
	file_zetasql_public_proto_wire_format_annotation_proto_rawDescOnce sync.Once
	file_zetasql_public_proto_wire_format_annotation_proto_rawDescData []byte
)

func file_zetasql_public_proto_wire_format_annotation_proto_rawDescGZIP() []byte {
	file_zetasql_public_proto_wire_format_annotation_proto_rawDescOnce.Do(func() {
		file_zetasql_public_proto_wire_format_annotation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zetasql_public_proto_wire_format_annotation_proto_rawDesc), len(file_zetasql_public_proto_wire_format_annotation_proto_rawDesc)))
	})
	return file_zetasql_public_proto_wire_format_annotation_proto_rawDescData
}

var file_zetasql_public_proto_wire_format_annotation_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_zetasql_public_proto_wire_format_annotation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_zetasql_public_proto_wire_format_annotation_proto_goTypes = []any{
	(TableType)(0),                           // 0: zetasql.TableType
	(*WireFormatAnnotationEmptyMessage)(nil), // 1: zetasql.WireFormatAnnotationEmptyMessage
	(*descriptorpb.FieldOptions)(nil),        // 2: google.protobuf.FieldOptions
	(*descriptorpb.MessageOptions)(nil),      // 3: google.protobuf.MessageOptions
}
var file_zetasql_public_proto_wire_format_annotation_proto_depIdxs = []int32{
	2, // 0: zetasql.struct_field_name:extendee -> google.protobuf.FieldOptions
	2, // 1: zetasql.is_raw_proto:extendee -> google.protobuf.FieldOptions
	2, // 2: zetasql.is_hidden_column:extendee -> google.protobuf.FieldOptions
	2, // 3: zetasql.is_measure:extendee -> google.protobuf.FieldOptions
	3, // 4: zetasql.is_wrapper:extendee -> google.protobuf.MessageOptions
	3, // 5: zetasql.is_struct:extendee -> google.protobuf.MessageOptions
	3, // 6: zetasql.table_type:extendee -> google.protobuf.MessageOptions
	0, // 7: zetasql.table_type:type_name -> zetasql.TableType
...
func init() { file_zetasql_public_proto_wire_format_annotation_proto_init() }
func file_zetasql_public_proto_wire_format_annotation_proto_init() {
	if File_zetasql_public_proto_wire_format_annotation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zetasql_public_proto_wire_format_annotation_proto_rawDesc), len(file_zetasql_public_proto_wire_format_annotation_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 7,
			NumServices:   0,
		},
		GoTypes:           file_zetasql_public_proto_wire_format_annotation_proto_goTypes,
		DependencyIndexes: file_zetasql_public_proto_wire_format_annotation_proto_depIdxs,
		EnumInfos:         file_zetasql_public_proto_wire_format_annotation_proto_enumTypes,
		MessageInfos:      file_zetasql_public_proto_wire_format_annotation_proto_msgTypes,
		ExtensionInfos:    file_zetasql_public_proto_wire_format_annotation_proto_extTypes,
	}.Build()
	File_zetasql_public_proto_wire_format_annotation_proto = out.File
	file_zetasql_public_proto_wire_format_annotation_proto_goTypes = nil
	file_zetasql_public_proto_wire_format_annotation_proto_depIdxs = nil
}
