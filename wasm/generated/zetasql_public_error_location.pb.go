...
func (x *ErrorLocation) Reset() {
	*x = ErrorLocation{}
	mi := &file_zetasql_public_error_location_proto_msgTypes[0]
...
func (*ErrorLocation) Descriptor() ([]byte, []int) {
	return file_zetasql_public_error_location_proto_rawDescGZIP(), []int{0}
}
...
func (x *ErrorSource) Reset() {
	*x = ErrorSource{}
	mi := &file_zetasql_public_error_location_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ErrorSource) Descriptor() ([]byte, []int) {
	return file_zetasql_public_error_location_proto_rawDescGZIP(), []int{1}
}
...
var File_zetasql_public_error_location_proto protoreflect.FileDescriptor

const file_zetasql_public_error_location_proto_rawDesc = "" +
	"\n" +
	"#zetasql/public/error_location.proto\x12\azetasql\"\x88\x02\n" +
	...
	"\x19input_start_column_offset\x18\x06 \x01(\x05R\x16inputStartColumnOffset\x127\n" +
	"\ferror_source\x18\x04 \x03(\v2\x14.zetasql.ErrorSourceR\verrorSource\"\xae\x01\n" +
	"\vErrorSource\x12#\n" +
	"\rerror_message\x18\x01 \x01(\tR\ferrorMessage\x12;\n" +
	"\x1aerror_message_caret_string\x18\x02 \x01(\tR\x17errorMessageCaretString\x12=\n" +
	"\x0eerror_location\x18\x03 \x01(\v2\x16.zetasql.ErrorLocationR\rerrorLocationB\x14\n" +
	"\x12com.google.zetasql"

var (
	file_zetasql_public_error_location_proto_rawDescOnce sync.Once
	file_zetasql_public_error_location_proto_rawDescData []byte
)

func file_zetasql_public_error_location_proto_rawDescGZIP() []byte {
	file_zetasql_public_error_location_proto_rawDescOnce.Do(func() {
		file_zetasql_public_error_location_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zetasql_public_error_location_proto_rawDesc), len(file_zetasql_public_error_location_proto_rawDesc)))
	})
	return file_zetasql_public_error_location_proto_rawDescData
}

var file_zetasql_public_error_location_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_zetasql_public_error_location_proto_goTypes = []any{
	(*ErrorLocation)(nil), // 0: zetasql.ErrorLocation
	(*ErrorSource)(nil),   // 1: zetasql.ErrorSource
}
var file_zetasql_public_error_location_proto_depIdxs = []int32{
	1, // 0: zetasql.ErrorLocation.error_source:type_name -> zetasql.ErrorSource
	0, // 1: zetasql.ErrorSource.error_location:type_name -> zetasql.ErrorLocation
...
func init() { file_zetasql_public_error_location_proto_init() }
func file_zetasql_public_error_location_proto_init() {
	if File_zetasql_public_error_location_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zetasql_public_error_location_proto_rawDesc), len(file_zetasql_public_error_location_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zetasql_public_error_location_proto_goTypes,
		DependencyIndexes: file_zetasql_public_error_location_proto_depIdxs,
		MessageInfos:      file_zetasql_public_error_location_proto_msgTypes,
	}.Build()
	File_zetasql_public_error_location_proto = out.File
	file_zetasql_public_error_location_proto_goTypes = nil
	file_zetasql_public_error_location_proto_depIdxs = nil
}
